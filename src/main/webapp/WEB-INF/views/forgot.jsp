...
<head>
    ...
    <title>Forgot Password - Secure File Sharing</title>
...
<body>
  ...
  <div class="login-container">
    <div class="login-card">
      ...
      <p class="subtitle">Verify your identity to update your password</p>
      ...
      <form action="reset_password" method="post">
        ...
        <div class="input-wrapper">
          <input type="email" placeholder="Registered Email" name="email" required autocomplete="off">
          <i class="fa fa-envelope-o"></i>
        </div>

        <div class="input-wrapper">
          <input type="password" placeholder="New Password" name="new_pword" required>
      ...
      <div class="register-link">
        Remembered your password? <a href="login1">Back to Login</a>
      </div>
    </div>
  </div>
